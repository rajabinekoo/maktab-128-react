function renderForm() {
  return `
    <form
      onsubmit="formState.formSubmitHandler(event)"
      class="shadow mx-auto max-w-[500px] bg-white border-2 border-slate-200 rounded-xl p-4 space-y-3"
    >
...
const formState = {
  ...
  formSubmitHandler(event) {
    ...
    movies.push(new GenerateMovie(this.movieName, this.movieRate));
